...
Color pinkColor = const Color(0xffBA788C);
Color blackColor = const Color(0xff000000);
Color biancaColor = const Color(0xffF5ECE0);
Color textColor = const Color(0xff917F74);
Color navigasibarColor = const Color(0xff1E1E1E);
Color iconbarColor = const Color(0xffCDCDCD);
